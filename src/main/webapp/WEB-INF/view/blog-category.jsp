        ...
        <div class="wrapper">
            <div class="grid-view">
                <c:forEach items="${pagination}" var="pagination" varStatus="status">
                    <div class="grid">
                        <a href="${url.base}/category/${pagination.path}/">
                            <div class="preview">
                                <img src="${url.panel}${path.image}/blog/category/thumbnail/${pagination.thumbnail}"
                                     alt="${setting.name} Video Category ${pagination.name} Thumbnail"/>
                            </div>
                        </a>
                        <a href="${url.base}/category/${pagination.path}/">
